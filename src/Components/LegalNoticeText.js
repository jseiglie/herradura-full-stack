...
const LegalNoticeText = props => {
  return (
   <article>
    NOMBRE EMPRESA, S.L., responsable del sitio web, en adelante
...
aplicación.
NOMBRE EMPRESA, S.L.,. se reserva el derecho de modificar cualquier tipo de
...
entendiéndose como suficiente con la publicación en el sitio web de NOMBRE
EMPRESA, S.L.,
...
no puedan excluirse tales declaraciones y garantías.
11. FUERZA MAYOR
