  ...
  return (
    <article className="container mb-5">
      ...
      <div className="my-5">
        ...
        de cual es titular <em>{props.owner}</em>
      </div>
      <h3 className="my-5">INFORMACIÓN RELEVANTE</h3>
      <div>
        <p>
        ...
        <p>
          ...
          nuestros productos. {props.companyName} no asume la responsabilidad en
      ...
      <h3 className="my-5">LICENCIA</h3>
      {props.companyName} a través de su sitio web concede una licencia para que
      los usuarios utilicen los productos que son vendidos en este sitio web de
      acuerdo a los Términos y Condiciones que se describen en este documento.
      USO NO AUTORIZADO En caso de que aplique (para venta de software,
      templetes, u otro producto de diseño y programación) usted no puede
      colocar uno de nuestros productos, modificado o sin modificar, en un CD,
      sitio web o ningún otro medio y ofrecerlos para la redistribución o la
      reventa de ningún tipo. PROPIEDAD Usted no puede declarar propiedad
      ...
      implícita. En ningún caso esta compañía será responsables de ningún daño
      ...
      <h3 className="my-5">POLÍTICA DE REEMBOLSO Y GARANTÍA </h3>En el caso de productos que sean
      mercancías irrevocables no-tangibles, no realizamos reembolsos después de
      que se envíe el producto, usted tiene la responsabilidad de entender las
      características antes de comprarlo. Le pedimos que lea cuidadosamente la
      descripción antes de comprarlo. Solo se hacen excepciones de esta regla
      ...
      cubrirá fallas de fábrica y solo se hará efectiva cuando el producto se
      ...
      sóolo se harán efectivos estos términos si el equipo ha sido usado
      correctamente. Esto incluye:  De acuerdo a las especificaciones técnicas
      indicadas para cada producto.  En condiciones ambientales acordes con las
      especificaciones indicadas por el fabricante.  En uso específico para la
      función con que fue diseñado de fábrica.  En condiciones de operación
      eléctricas acordes con las especificaciones y tolerancias indicadas.
      COMPROBACIÓN ANTIFRAUDE La compra del cliente puede ser aplazada para la
      comprobación antifraude. También puede ser suspendida por más tiempo para
      una investigación más rigurosa, para evitar transacciones fraudulentas.
      <h3 className="my-5">PRIVACIDAD</h3>
      {props.companyName} garantiza que la información personal que usted envía
      cuenta con la seguridad necesaria. Los datos ingresados por usuario o en
      el caso de requerir una validación de los pedidos no serán entregados a
      terceros, salvo que deba ser revelada en cumplimiento a una orden judicial
      o requerimientos legales. La suscripción a boletines de correos
      electrónicos publicitarios es voluntaria y podría ser seleccionada al
      momento de crear su cuenta. {props.companyName} se reserva los derechos de
