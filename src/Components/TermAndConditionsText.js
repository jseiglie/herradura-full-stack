...
en tal caso estarían sujetas a sus propios Términos y Condiciones. En algunos casos,
...
para la compra de alguno de nuestros productos. ………………………. no asume la
...
modificar, en un CD, sitio web o ningún otro medio y ofrecerlos para la redistribución o
la reventa de ningún tipo.
PROPIEDAD
...
productos se proporcionan sin ningún tipo de garantía, expresa o implícita. En ningún
caso esta compañía será responsables de ningún daño incluyendo, pero no limitado a,
...
responsabilidad de entender las características antes de comprarlo. Le pedimos que
lea cuidadosamente la descripción antes de comprarlo. Solo se hacen excepciones de
esta regla cuando la descripción no se ajusta al producto.
Hay algunos productos que pudieran tener garantía y posibilidad de reembolso, pero
este será especificado al comprar el producto. En tales casos la garantía solo cubrirá
fallas de fábrica y solo se hará efectiva cuando el producto se haya usado
correctamente.
La garantía no cubre averías o daños ocasionados por uso indebido. Los términos de
la garantía están asociados a fallas de fabricación y funcionamiento en condiciones
normales de los productos y sóolo se harán efectivos estos términos si el equipo ha
sido usado correctamente. Esto incluye:
 De acuerdo a las especificaciones técnicas indicadas para cada producto.
 En condiciones ambientales acordes con las especificaciones indicadas por el
fabricante.
 En uso específico para la función con que fue diseñado de fábrica.
 En condiciones de operación eléctricas acordes con las especificaciones y
tolerancias indicadas.
COMPROBACIÓN ANTIFRAUDE
La compra del cliente puede ser aplazada para la comprobación antifraude. También
puede ser suspendida por más tiempo para una investigación más rigurosa, para evitar
transacciones fraudulentas.
PRIVACIDAD
…………………………….. garantiza que la información personal que usted envía
cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de
requerir una validación de los pedidos no serán entregados a terceros, salvo que deba
...
…………………………….. se reserva los derechos de cambiar o de modificar estos
